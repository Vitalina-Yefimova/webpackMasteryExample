...
module.exports = __webpack_require__.p + "assets/images/word-heyf49d77e6e7d930fb4b83.jpg";
...
imgElement.src = _assets_images_word_hey_jpg__WEBPACK_IMPORTED_MODULE_3__;
imgElement.alt = 'Image with word Hey';
imgElement.style.marginTop = '15px';
document.body.appendChild(imgElement);
const button = document.querySelector('button');
if (button) {
  button.addEventListener('click', _js_script__WEBPACK_IMPORTED_MODULE_2__.greeting);
} else {
